...
import com.craftfest.models.WreathModel;

public class WreathRenderer extends TileEntitySpecialRenderer {

	 //The model of your block
    private final WreathModel model;
    
    public WreathRenderer() {
            this.model = new WreathModel();
    }
