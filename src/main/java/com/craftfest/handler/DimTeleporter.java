...
//https://github.com/Shinoow/AbyssalCraft/blob/c4b89b16adcca68709cf4093d4e04c52c5805d78/src/main/java/com/shinoow/abyssalcraft/common/world/TeleporterAbyss.java
...
public class DimTeleporter extends Teleporter {
	...
	public DimTeleporter(WorldServer server) {
		//TODO: add another constructor to get dim id?
		
		super(server);
		worldServerInstance = server;
		random = new Random(server.getSeed());
