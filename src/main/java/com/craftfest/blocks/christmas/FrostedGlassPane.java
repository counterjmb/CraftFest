...
public class FrostedGlassPane extends BlockPane {
    ...
    {
        super("frostedglasspane", "frostedglasspane", Material.glass, true);
        this.setCreativeTab(CraftFestMod.tabWinter);
        setBlockName("frostedglasspane");
        setBlockTextureName("frostedglasspane");
    ...
    public void registerBlockIcons(IIconRegister icon)
    {
        ...
        this.blockIcon = icon.registerIcon(CraftFestMod.MODID + ":frostedglasspane");
        this.icon = icon.registerIcon(CraftFestMod.MODID + ":frostedglasspane");
    }
