...
public class CraftFestChunkProvider implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public CraftFestChunkProvider(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
     ...
     */
    public void populate(IChunkProvider chunk, int p_73153_2_, int p_73153_3_)
    {
        ...
        MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Pre(chunk, worldObj, rand, p_73153_2_, p_73153_3_, flag));
        ...
        if (biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && !flag && this.rand.nextInt(4) == 0
            && TerrainGen.populate(chunk, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAKE))
        {
        ...
        if (TerrainGen.populate(chunk, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAVA) && !flag && this.rand.nextInt(8) == 0)
        {
            k1 = k + this.rand.nextInt(16) + 8;
        ...
        boolean doGen = TerrainGen.populate(chunk, worldObj, rand, p_73153_2_, p_73153_3_, flag, DUNGEON);
        ...
        if (TerrainGen.populate(chunk, worldObj, rand, p_73153_2_, p_73153_3_, flag, ANIMALS))
        {
        ...
        doGen = TerrainGen.populate(chunk, worldObj, rand, p_73153_2_, p_73153_3_, flag, ICE);
        ...
        MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Post(chunk, worldObj, rand, p_73153_2_, p_73153_3_, flag));
