/*
 * COPIED EVERYTHING FROM NET MINECRAFT WORLD GEN
 */
...
public class ModChunkProvider implements IChunkProvider
{
    private Random rand;
    ...
    public ModChunkProvider(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_)
    {
